...
if (result.hasError){
  ...
  return (
    <Box sx={{ p: 2 }}>
      ...
      <form style={{ width: "100%" }} onSubmit={handleFormSubmit} encType="multipart/form-data"> 
        <CreateMainHeader setMainH={setMainH}  mainH={mainH}  setMainImage={setMainImage} mainImage={mainImage}/>
        <Box>
          <FormControlLabel
            control={<Switch value={showP1} onChange={() => setShowP1(!showP1)} /> }
            label="Add Paragraph 1"
          />
          {showP1 && <HeadingsTemplate  p={"1"} setP={setP1} pData={p1} H={pH1} setH={setPH1} image={imageP1} setImage={setImageP1}/>}
        </Box>
        <Box>
          <FormControlLabel control={ <Switch value={showP2} onChange={() => setShowP2(!showP2)}/>}
          label="Add Paragraph 2"
          />
          {showP2 && <HeadingsTemplate p={"2"} setP={setP2} pData={p2} H={pH2} setH={setPH2} image={imageP2} setImage={setImageP2}/>}
        </Box>
        <Box>
          <FormControlLabel
            control={<Switch value={showP3} onChange={() => setShowP3(!showP3)}/>}
            label="Add Paragraph 3"
          />
          {showP3 && <HeadingsTemplate p={"3"} setP={setP3} pData={p3} H={pH3} setH={setPH3} image={imageP3} setImage={setImageP3}/>}
        </Box>
