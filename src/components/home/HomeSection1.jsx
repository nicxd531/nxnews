                ...
                <>
                    <Box sx={{ width: "100%", height: { xs: "200px", lg: "250px" }, display: "flex", justifyContent: "space-between", mb: 2 }}>
                        ...
                        <Box sx={{ height: "100%", width: { xs: "49%", lg: "59%" } }}>
                            ...
                            <Typography variant="h6" sx={{ fontSize: { xs: "0.8rem", lg: "2rem" }, textTransform: "capitalize", mb: { lg: 2 } }}>{hotTopic[0]?.user?.location}, {formattedDate}</Typography>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", mt: { xs: 1, lg: 3 } }}>
                        {others?.map((data, index) => {
                            ...
                            // Assuming `createdAt` is a JavaScript Date object or a valid date string
