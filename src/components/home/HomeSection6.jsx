...
function HomeSection6({ post, error }) {
    // home section 6 component and const for filtered data ,sliced data and mapdata
            ...
            {( Array.isArray(filteredData) && filteredData?.length > 0)  ? (
                ...
                <>
                    <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 4 }}>
                        ...
                        <Button variant='contained' sx={{ textTransform: "capitalize", fontSize: { xs: "0.7rem", lg: "1rem" } }}><Link href={"/entertainment"}> View All</Link></Button>
                    </Box>
                    <hr />
