...
function HomeSection9({ post, error }) {
    // home section 6 component and const  for holding filtered data ,sliced data and map data
    const filteredData = post?.filter((data) => data.categories == "Health")
            ...
            {(Array.isArray(filteredData) && filteredData?.length > 0) ? (
                ...
                <>
                    <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 4 }}>
                        <Typography variant='h4' sx={{ fontWeight: "bold", fontSize: { xs: "1.3rem", lg: "2.5rem" } }}> Health</Typography>
                        <Button variant='contained' sx={{ textTransform: "capitalize", fontSize: { xs: "0.7rem", lg: "1rem" } }}><Link href={"/health"}>View All</Link> </Button>
                    </Box>
                    <hr />
