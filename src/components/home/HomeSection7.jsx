...
function HomeSection7({ post, error }) {
    // home section 7 component and const for  filtered data ,sliced data and mapdata
            ...
            {( Array.isArray(filteredData) && filteredData?.length > 0) ? (
                ...
                <>
                    <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 4 }}>
                        <Typography variant='h4' sx={{ fontWeight: "bold", fontSize: { xs: "1.3rem", lg: "2.5rem" } }}> Political</Typography>
                        <Button variant='contained' sx={{ textTransform: "capitalize", fontSize: { xs: "0.7rem", lg: "1rem" } }}><Link href={"/political"}>View All</Link> </Button>
                    </Box>
                    <hr />
