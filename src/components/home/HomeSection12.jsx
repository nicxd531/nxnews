...
function HomeSection12() {
    return (
        <Box sx={{p: {xs:2,lg:6}}}>
            ...
            <Box sx={{px:{xs:5,lg:30},textAlign:"center",color:"white", bgcolor: "grey", borderRadius: "10px",height:"400px",width:"100%",display:"flex",justifyContent:"center",alignItem:"center", flexDirection:"column"}}>
                <Typography variant='h3' sx={{fontSize:{xs:"2rem",lg:"4rem"}}}> Get The latest notifications and info from us </Typography>
                <Typography className="text-muted" sx={{mt:{xs:2,lg:4}}}>Lorem ipsum dolor sit amet consectetur adipiscing, elit inceptos condimentum blandit dis, in neque praesent penatibus massa. Egestas rutrum ac per sociosqu tempor augue a neque, velit sagittis magnis nibh odio torquent quisque interdum nullam, mauris ad viverra curabitur morbi metus felis</Typography>
