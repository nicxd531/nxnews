    ...
    return (
        <Box sx={{ width: "100%", mt: {xs:2,lg:4} }}>
            ...
            <Box sx={{width:"100%",display:"flex",flexDirection:{xs:"column",lg:"row"},flexWrap:"wrap",justifyContent:"space-around"}}>
                <TextField onClick={(e)=>setOccupation(e.target.value)} id="outlined-basic" label="Occupation" variant="outlined" sx={{width:{xs:"100%",lg:"45%"},mt:{xs:2,lg:3}}}/>
                <TextField onClick={(e)=>setLocation(e.target.value)} id="outlined-basic" label="Location" variant="outlined" sx={{width:{xs:"100%",lg:"45%"},mt:{xs:2,lg:3}}}/>
            </Box>
        </Box>
    )
}
